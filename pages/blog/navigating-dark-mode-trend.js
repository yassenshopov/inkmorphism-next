...
export default function Article() {
  ...
  const importData = async () => {
    try {
      ...
      setArticleData(
        articleDataJSON.default.filter(
          (item) => item.urlSlug !== "navigating-dark-mode-trend"
        )
      );
  ...
  return (
    <div className={"Article"}>
      <Head>
        ...
        <meta
          name="description"
          content="Discover the benefits of dark mode in web design and learn how to design websites that prioritize eye comfort. Navigate the dark mode trend with practical tips and techniques."
        />
        <link rel="icon" href="/faviconWh.ico" />
        <meta
          property="og:image"
          content="https://firebasestorage.googleapis.com/v0/b/inkmorphism.appspot.com/o/blog%2Fnavigating-dark-mode-trend%2Fthumbnail.webp?alt=media&token=ba740e3e-4ff7-4321-a7f9-f7e876409a8a&_gl=1*1tospw6*_ga*MTE1NDIyNjIyMi4xNjczMTk2MTM5*_ga_CW55HF8NVT*MTY4NjM5NDIzOS45MS4xLjE2ODYzOTYyOTMuMC4wLjA."
        ></meta>
        <meta property="og:type" content="website"></meta>
        <meta
          property="og:title"
          content="Navigating the Dark Mode Trend: Designing Websites"
        ></meta>
        <meta
      ...
      <main>
        ...
        <article id="article">{processedMD}</article>
        <aside>
